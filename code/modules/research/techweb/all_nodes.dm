...
/datum/techweb_node/nanite_military
	id = "nanite_military"
	...
	design_ids = list("nanojutsu_nanites")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1500, TECHWEB_POINT_TYPE_NANITES = 1500)
	export_price = 7500
