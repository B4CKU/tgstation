...
/obj/item/toy/prize/phazon
	...
	special_attack_type = SPECIAL_ATTACK_UTILITY
	special_attack_cry = "ANOMALY ATTACK"
...
/obj/item/toy/prize/alpha
	name = "toy Alpha"
	desc = "14/14"
	icon_state = "alphatoy"
	max_combat_health = 5 //200 integrity
	special_attack_type = SPECIAL_ATTACK_OTHER
	special_attack_type_message = "attacks several times in a single turn."
	special_attack_cry = "CHASE MODE"

/obj/item/toy/prize/alpha/super_special_attack(obj/item/toy/prize/victim) 
